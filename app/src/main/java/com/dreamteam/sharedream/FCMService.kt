...
//            //push를 전달받으면 동작해야 할 함수를 호출
        ...
        if (remoteMessage.notification != null) {
            //알림생성
            sendNonotification(remoteMessage)
    ...
    @RequiresApi(Build.VERSION_CODES.O)
    private fun sendNonotification(remoteMessage: RemoteMessage) {
        Log.d("nyh", "sendNonotification:알림전 ${remoteMessage.notification?.title} ")
        //channel 설성
